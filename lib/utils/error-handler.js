...
var cbCalled = false
  ...
  , constants
  , itWorked = false
  , isHomebrew = __filename.match(/\/Cellar\//)
...
function errorHandler (er) {
  ...
  default:
    ...
    if(isHomebrew) {
      log.error([""
                ,"It looks like you've installed npm with Homebrew."
                ,"That is not supported, or recommended."
                ,"If that is indeed the case, then please"
                ,"report this bug at <http://github.com/mxcl/homebrew/issues>"
                ].join("\n"))
    }
  }
